...
class FileErrorCodesTest {
  ...
  void excelExportFailedShouldExist() {
    assertThat(FileErrorCodes.EXCEL_EXPORT_FAILED.getCode()).isEqualTo("SERVICE.FILE.0009");
    assertThat(FileErrorCodes.EXCEL_EXPORT_FAILED.getMessage()).isEqualTo("Excel 模板填充失败");
  }
}
