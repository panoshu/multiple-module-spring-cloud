package com.example.core.domain.aggregateroot;

import com.example.core.domain.vauleobject.BusinessContext;
import com.example.core.domain.vauleobject.BusinessFile;
import com.example.core.domain.vauleobject.BusinessMetaContext;
import com.example.core.domain.vauleobject.OperatorInfo;
import com.example.core.domain.vauleobject.reference.PlanBizApplicationRef;
import com.example.core.domain.vauleobject.enums.status.FormStatus;
