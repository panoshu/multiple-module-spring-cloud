...
public class SanitizationContext {
  ...
  // 规则缓存
  private volatile Map<String, SanitizationRule> jsonPathRules;
  private volatile Map<String, SanitizationRule> headerRules;
  private volatile Map<String, SanitizationRule> queryRules;
