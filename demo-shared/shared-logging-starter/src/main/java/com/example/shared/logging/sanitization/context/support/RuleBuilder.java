package com.example.shared.logging.sanitization.context.support;
...
public class RuleBuilder {
   ...
   */
  public Map<String, SanitizationRule> buildJsonPathRules(
    Map<String, SanitizationRule> fieldConfigs,
    boolean enableWildcardPaths) {

    Map<String, SanitizationRule> rules = new ConcurrentHashMap<>();
   ...
   * 规则：只提取 header. 开头的
   */
  public Map<String, SanitizationRule> buildHeaderRules(
    Map<String, SanitizationRule> fieldConfigs) {
   ...
   * 规则：只提取 query. 开头的
   */
  public Map<String, SanitizationRule> buildQueryRules(
    Map<String, SanitizationRule> fieldConfigs) {
  ...
  private void autoRegisterRecursivePaths(String jsonPath, SanitizationRule config,
                                          Map<String, SanitizationRule> rules) {
