...
import com.example.shared.logging.sanitization.context.support.ConfigurationValidator;
import com.example.shared.logging.sanitization.context.support.RuleBuilder;
...
import com.example.shared.logging.sanitization.sanitizer.impl.HeaderSanitizer;
import com.example.shared.logging.sanitization.sanitizer.impl.JsonBodySanitizer;
import com.example.shared.logging.sanitization.sanitizer.impl.QueryParamSanitizer;
...
import com.example.shared.logging.sanitization.strategy.SanitizationStrategyFactory;
import com.example.shared.logging.sanitization.strategy.impl.*;
import com.example.shared.logging.sanitization.strategy.validator.StrategyValidator;
import com.example.shared.logging.sanitization.strategy.validator.StrategyValidatorFactory;
import com.example.shared.logging.sanitization.strategy.validator.impl.*;
...
public class LogSanitizationConfiguration {
  ...
  public FullValidator fullValidator() {
    return new FullValidator();
  }

  @Bean
  @ConditionalOnMissingBean
  public PartialHideValidator partialHideValidator() {
    return new PartialHideValidator();
  }

  @Bean
  @ConditionalOnMissingBean
  public KeepFirstLastValidator keepFirstLastValidator() {
    return new KeepFirstLastValidator();
  }

  @Bean
  @ConditionalOnMissingBean
  public HashSHA256Validator hashSHA256Validator() {
    return new HashSHA256Validator();
  }

  @Bean
  @ConditionalOnMissingBean
  public PatternRegexValidator patternRegexValidator() {
    return new PatternRegexValidator();
  }
  ...
  @Bean
  @ConditionalOnMissingBean
  public FullSanitizationStrategy fullStrategy() {
    return new FullSanitizationStrategy();
  }
  ...
  @Bean
  @ConditionalOnMissingBean
  public HashSHA256Strategy hashSHA256Strategy() {
