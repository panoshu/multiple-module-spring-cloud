package com.example.shared.lock.autoconfigure;

import com.example.shared.lock.DistributedLock;
import com.example.shared.lock.RedissonDistributedLock;
 ...
 * 与 {@link com.example.shared.lock.DistributedLockFactory#getLock} 的查找契约一致。
 * <p>
