...
@Slf4j
public class JaywayJsonBodySanitizer implements LogSanitizer { // 去掉 implements BodyFilter
  ...
  public JaywayJsonBodySanitizer(SanitizationContext config, ValueSanitizer valueSanitizer) {
  ...
  public String handler(String contentType, @NotNull String body) {
