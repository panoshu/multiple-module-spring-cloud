package com.example.shared.logging.aspect;

import com.example.shared.logging.annotation.WithDurationLogging;
...
public class MethodTimingAspect {
  ...
  @Around("@annotation(com.example.shared.logging.annotation.WithDurationLogging)")
