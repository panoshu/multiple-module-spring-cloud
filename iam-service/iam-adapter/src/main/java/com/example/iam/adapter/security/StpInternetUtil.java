...
/**
 * 网上渠道 StpLogic 工具类(企业经办人)。
 *
 * <p>对应 sa-token 多 StpLogic 集成的 INTERNET 渠道,loginType 为 {@code "internet"},
 * Token Header 名称为 {@code "satoken-internet"}。Token 互不干扰,便于独立管理。
 *
