...
public record PasswordChanged(
  ...
  public static PasswordChanged of(CredentialId credentialId, UserNo createdBy) {
    return new PasswordChanged(credentialId, EventId.generate(), LocalDateTime.now(), createdBy);
  }
}
